const cardArray = [
    { name: 'gato', img: 'img/png-transparent-redbubble-polite-cat-meme-funny-cat-meme-thumbnail.png' },
    { name: 'gato', img: 'img/png-transparent-redbubble-polite-cat-meme-funny-cat-meme-thumbnail.png' },
    { name: 'cachorro', img: 'img/download.jpeg' },
    { name: 'cachorro', img: 'img/download.jpeg' },
    { name: 'coelho', img: 'img/coelho.jpeg' },
    { name: 'coelho', img: 'img/coelho.jpeg' },
    { name: 'hamster', img: 'img/hamster.jpeg' },
    { name: 'hamster', img: 'img/hamster.jpeg' }
    ];
